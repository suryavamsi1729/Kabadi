...
class SignUpTeam extends StatefulWidget {
  const SignUpTeam({super.key});

  @override
  State<SignUpTeam> createState() => _SignUpTeamState();
}

class _SignUpTeamState extends State<SignUpTeam> {
